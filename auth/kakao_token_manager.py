...
class KakaoTokenManager:
    ...
    async def get_vaild_token(self):
        ...
        access_token, refresh_token = token_info["access_token"], token_info["refresh_token"]
    ...
    async def _get_token_info(self):
        try:
            ...
            decoded_token = jwt.decode(encoded_token, self.jwt_token, algorithms="HS256")
            access_token, refresh_token = decoded_token.get("access_token"), decoded_token.get("refresh_token")
    ...
    async def _refresh_access_token(self, refresh_token):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                new_token["refresh_token"] = result["refresh_token"] if "refresh_token" in result else refresh_token

                encode_new_token = jwt.encode(new_token, self.jwt_token, algorithm="HS256")
